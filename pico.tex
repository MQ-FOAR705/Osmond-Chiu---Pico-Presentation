...
\includegraphics[width=1\textwidth,height=0.60\textheight,keepaspectratio]{%
figure/Pico.png}\\Three useful, integrated tools for any researcher:
\begin{itemize}
    \item Zotero,
    \item Hypothes.is 
...
figure/OpenSemantictagging.png}\includegraphics[width=0.9\textwidth,height=0.5\textheight,keepaspectratio]{%
figure/OpenSemanticfacets.png}  
\includegraphics[width=0.9\textwidth,height=0.5\textheight,keepaspectratio]{%
...
figure/ZoteroISBN.png}

\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{%
figure/ZoteroSync.png}
...
\includegraphics[width=0.5\textwidth,height=0.7\textheight,keepaspectratio]{%
